...
public class Tree_PageFactory {
	...
	@CacheLookup
	public WebElement tree_getStarted_btn;
	...
	@CacheLookup
	public WebElement practice_content;
	...
	public String tree_main_getTitle() {
		return tree_main_title.getText();
	}
