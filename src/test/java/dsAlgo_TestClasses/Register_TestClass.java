...
public class Register_TestClass extends BaseClass {
	...
	public void callregisterBothPwdBlank(String username, String password, String confirmpwd, String message)
	...
	public void callregisterUnameBlank(String username, String password, String confirmpwd, String message)
			throws InterruptedException, IOException {
	...
	public void callregisterOnePwdBlank(String username, String password, String confirmpwd, String message)
			throws InterruptedException, IOException {
	...
	public void callregisterInvalidUname(String username, String password, String confirmpwd, String message)
			throws InterruptedException, IOException {
	...
	public void callregisterPwdLessLength(String username, String password, String confirmpwd, String message)
			throws InterruptedException, IOException {
	...
	public void callregisterPwdNumeric(String username, String password, String confirmpwd, String message)
			throws InterruptedException, IOException {
	...
	public void callregisterCommonPwd(String username, String password, String confirmpwd, String message)
			throws InterruptedException, IOException {
	...
	/*
	 * @Test(priority = 8, dataProvider = "registerValidData", dataProviderClass =
	 * DataProviderClass.class) public void callregisterValidData(String username,
	 * String password, String confirmpwd, String message) throws
	 * InterruptedException, IOException {
	 * 
	 * registerPage.registerLinkClick(); registerPage.enterusername(username);
	 * registerPage.enterpassword(password);
	 * registerPage.enterpwdConfirm(confirmpwd); registerPage.registerBtnClick();
	 * String InvalidMsg = registerPage.invalidMsg();
	 * Assert.assertEquals(InvalidMsg, message);
	 * LoggerReader.info("Please fill out this field.");
	 * 
	 * }
	 */
	// This is code for valid login. To avoid new id generation this is commented.
